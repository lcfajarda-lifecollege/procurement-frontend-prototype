...
const demoRequests: PurchaseRequest[] = [
  ...
  { id:'PR-2026-1022', title:'Administration Workplace Refresh', department:'Administration', amount:152100, category:'Multiple categories', requester:'Lem Fajarda', status:'RFQ Sent', due:'In 11 days', items:[{name:'Laptop Computer',category:'Technology',description:'14-inch business laptop, Core Ultra 7 class, 16 GB RAM, 512 GB SSD',uom:'UNIT',quantity:3,unitPrice:45000},{name:'Printer Ink',category:'Operational supplies',description:'Original high-yield ink cartridge compatible with office printers',uom:'CARTRIDGE',quantity:12,unitPrice:950},{name:'Bond Paper A4',category:'Operational supplies',description:'A4, 80 gsm, 500 sheets per ream',uom:'REAM',quantity:20,unitPrice:285}], createdAt:'2026-08-28T01:00:00Z', updatedAt:'2026-08-28T05:00:00Z', rfqQuotes:[{...lifecycleSeedQuote('Power Mac Center, Inc.','education@powermaccenter.com','Viewed','RFQ-2026-1022-TECH-A',[{name:'Laptop Computer',unitPrice:44200}],9),lotCategories:['Technology']},{...lifecycleSeedQuote('Enterprise Technology Solutions','bids@ets.example','Sent','RFQ-2026-1022-TECH-B',[{name:'Laptop Computer',unitPrice:45100}],7),lotCategories:['Technology']},{...lifecycleSeedQuote('Office Warehouse, Inc.','bids@officewarehouse.example','Viewed','RFQ-2026-1022-OPS-A',[{name:'Printer Ink',unitPrice:925},{name:'Bond Paper A4',unitPrice:278}],5),lotCategories:['Operational supplies']},{...lifecycleSeedQuote('Lem Fajarda Merchandise','sales@lemfajarda.example','Sent','RFQ-2026-1022-OPS-B',[{name:'Printer Ink',unitPrice:940},{name:'Bond Paper A4',unitPrice:282}],6),lotCategories:['Operational supplies']}], history:[{action:'create',actor:'lem.fajarda@life.edu.ph',detail:'Department Head and COO notified based on the ₱152,100 request total. Routed to Procurement Review.',createdAt:'2026-08-28T01:00:00Z'},{action:'complete_review',actor:'procurement@life.edu.ph',detail:'Procurement Review separated the request into Technology and Operational supplies sourcing lots.',createdAt:'2026-08-28T03:00:00Z'},{action:'send_rfq',actor:'procurement@life.edu.ph',detail:'Two category-specific RFQs sent: two technology vendors and two operational-supplies vendors.',createdAt:'2026-08-28T05:00:00Z'}] },
...
function loadRequestRecords(): PurchaseRequest[] {
  try {
    ...
    const merged = requiredSample && !records.some((request) => request.id === requiredSample.id) ? [requiredSample, ...records] : records;
